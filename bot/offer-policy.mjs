...
export function selectOffer(candidates,{categoryId,recentIds}){return candidates.filter(c=>valid(c,categoryId,recentIds)).sort((a,b)=>discount(b)-discount(a)||a.rank-b.rank||a.itemId.localeCompare(b.itemId))[0]??null;}
