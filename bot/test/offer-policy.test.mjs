...
test("hybrid ranking combines category-relative sales rank and discount",()=>{const candidates=[{...item,itemId:"BALANCED",rank:0,soldQuantity:100,price:80,originalPrice:100},{...item,itemId:"WEAK",rank:2,soldQuantity:10,price:95,originalPrice:100},{...item,itemId:"POPULAR",rank:1,soldQuantity:10000,price:50,originalPrice:100}];assert.deepEqual(selectOffers(candidates,{categoryId:item.categoryId,recentIds:new Set(),limit:3}).map(x=>x.itemId),["POPULAR","BALANCED","WEAK"]);});
